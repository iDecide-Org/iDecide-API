...
export class ChatGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect {
  ...
  async handleMessage(client: Socket, payload: { room: string; message: CreateMessageDto }): Promise<void> {
    ...
    this.logger.log(`Message received from ${client.id} for room ${payload.room}: ${payload.message.content}`);
